  ...
  const HospitalInfo: React.FC<HospitalInfoProps> = ({ name, overview }) => {
    ...
    return (
      <div className="bg-[#1e3e56] text-[#f7fbff] flex flex-row justify-around p-6 items-center rounded shadow-md w-[70vw] max-sm:w-[90vw] max-sm:flex-col max-sm:items-center max-sm:text-center rounded-[15px]">
        ...
        <div className="flex flex-row max-sm:flex max-sm:flex-col max-sm:items-center max-sm:text-center">
          ...
          <div className="ml-[1vw] max-sm:ml-0 max-sm:mt-2">{overview.totalPatients.toLocaleString()} Patients</div>
        </div>
        <div className="flex flex-row max-sm:flex max-sm:flex-col max-sm:items-center max-sm:text-center">
        ...
        <div className="flex flex-row max-sm:block text-align font-semibold">Satisfaction Rate :  {overview.satisfactionRate}</div>
      </div>
    );
  }
